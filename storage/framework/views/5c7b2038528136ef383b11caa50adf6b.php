<div class="sidebar">
  ...
  'barang') ? 'active' : ''); ?> ">
      ...
      <li class="nav-item">
        <a href="<?php echo e(url('/supplier')); ?>" class="nav-link <?php echo e(($activeMenu == 'supplier') ?
  'active' : ''); ?> ">
...
</div><?php /**PATH C:\laragon\www\PWL_POS\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>