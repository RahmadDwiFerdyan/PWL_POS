...
<head>
  ...
  <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>"> <!--utk mengirim token laravel CSRF pada setiap request ajax -->
  ...
  <?php echo $__env->yieldPushContent('css'); ?> <!-- memanggil custom CSS dari perintah push ('css') pd masing-masing view -->
</head>

<body class="hold-transition sidebar-mini">
  <!-- Site wrapper -->
  <div class="wrapper">
    <!-- Navbar --> <!-- element 1-header -->
  ...
  <?php echo $__env->yieldPushContent('js'); ?> <!-- memanggil custom js dari perintah push ('js') pd masing-masing view -->
</body>

</html><?php /**PATH C:\laragon\www\PWL_POS\resources\views/layouts/template.blade.php ENDPATH**/ ?>