        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="file_barang" id="file_barang" class="form-control" accept=".xls,.xlsx,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" required>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status) {
                        ...
                        tableBarang.ajax.reload(); // Memperbarui DataTable
                    } else {
                        $('.error-text').text('');
